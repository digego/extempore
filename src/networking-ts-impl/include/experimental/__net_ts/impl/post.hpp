...
#ifndef NET_TS_IMPL_POST_HPP
#define NET_TS_IMPL_POST_HPP
...
NET_TS_INITFN_RESULT_TYPE(CompletionToken, void()) post(
    NET_TS_MOVE_ARG(CompletionToken) token)
{
  ...
  ex.post(NET_TS_MOVE_CAST(handler)(init.completion_handler), alloc);
...
inline NET_TS_INITFN_RESULT_TYPE(CompletionToken, void()) post(
