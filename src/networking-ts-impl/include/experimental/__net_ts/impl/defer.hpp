...
#ifndef NET_TS_IMPL_DEFER_HPP
#define NET_TS_IMPL_DEFER_HPP
...
NET_TS_INITFN_RESULT_TYPE(CompletionToken, void()) defer(
    NET_TS_MOVE_ARG(CompletionToken) token)
{
  ...
  ex.defer(NET_TS_MOVE_CAST(handler)(init.completion_handler), alloc);
...
inline NET_TS_INITFN_RESULT_TYPE(CompletionToken, void()) defer(
