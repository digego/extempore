...
#ifndef NET_TS_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
#define NET_TS_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
...
public:
  ...
  NET_TS_DECL void restart_accept_op(socket_type s,
...
protected:
  ...
  NET_TS_DECL void start_send_to_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count,
  ...
  NET_TS_DECL void start_null_buffers_receive_op(
      base_implementation_type& impl,
      socket_base::message_flags flags, reactor_op* op);

  // Helper function to start an asynchronous receive_from operation.
  NET_TS_DECL void start_receive_from_op(base_implementation_type& impl,
  ...
  NET_TS_DECL void start_reactor_op(base_implementation_type& impl,
  ...
  // destroyed.
  NET_TS_DECL void close_for_destruction(base_implementation_type& impl);

  // Update the ID of the thread from which cancellation is safe.
  NET_TS_DECL void update_cancellation_thread_id(
      base_implementation_type& impl);
  ...
  // this service.
  NET_TS_DECL select_reactor& get_reactor();
  ...
  NET_TS_DECL void* interlocked_compare_exchange_pointer(
...
#endif // NET_TS_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
