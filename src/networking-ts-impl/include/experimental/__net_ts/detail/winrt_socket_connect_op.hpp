...
#ifndef NET_TS_DETAIL_WINRT_SOCKET_CONNECT_OP_HPP
#define NET_TS_DETAIL_WINRT_SOCKET_CONNECT_OP_HPP
...
{
public:
  NET_TS_DEFINE_HANDLER_PTR(winrt_socket_connect_op);
...
#endif // NET_TS_DETAIL_WINRT_SOCKET_CONNECT_OP_HPP
