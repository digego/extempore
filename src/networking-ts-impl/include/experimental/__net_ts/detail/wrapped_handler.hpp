...
#ifndef NET_TS_DETAIL_WRAPPED_HANDLER_HPP
#define NET_TS_DETAIL_WRAPPED_HANDLER_HPP
...
struct is_continuation_delegated
{
  ...
  {
    return networking_ts_handler_cont_helpers::is_continuation(handler);
  }
};
...
public:
  ...
  void operator()()
  {
    dispatcher_.dispatch(NET_TS_MOVE_CAST(Handler)(handler_));
  }
...
public:
  ...
  rewrapped_handler(rewrapped_handler&& other)
    : context_(NET_TS_MOVE_CAST(Context)(other.context_)),
      handler_(NET_TS_MOVE_CAST(Handler)(other.handler_))
  {
  }
#endif // defined(NET_TS_HAS_MOVE)
...
#endif // NET_TS_DETAIL_WRAPPED_HANDLER_HPP
