...
#ifndef NET_TS_DETAIL_REACTIVE_SOCKET_RECV_OP_HPP
#define NET_TS_DETAIL_REACTIVE_SOCKET_RECV_OP_HPP
...
{
public:
  NET_TS_DEFINE_HANDLER_PTR(reactive_socket_recv_op);
...
#endif // NET_TS_DETAIL_REACTIVE_SOCKET_RECV_OP_HPP
