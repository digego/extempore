...
#ifndef NET_TS_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
#define NET_TS_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
...
{
public:
  NET_TS_DEFINE_HANDLER_PTR(win_iocp_socket_recvfrom_op);
...
#endif // NET_TS_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
