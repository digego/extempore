...
#ifndef NET_TS_DETAIL_CONCURRENCY_HINT_HPP
#define NET_TS_DETAIL_CONCURRENCY_HINT_HPP
...
#define NET_TS_CONCURRENCY_HINT_ID 0xA5100000u
#define NET_TS_CONCURRENCY_HINT_ID_MASK 0xFFFF0000u
...
#define NET_TS_CONCURRENCY_HINT_IS_SPECIAL(hint) \
  ((static_cast<unsigned>(hint) \
    & NET_TS_CONCURRENCY_HINT_ID_MASK) \
      == NET_TS_CONCURRENCY_HINT_ID)

// Helper macro to determine if locking is enabled for a given facility.
#define NET_TS_CONCURRENCY_HINT_IS_LOCKING(facility, hint) \
  (((static_cast<unsigned>(hint) \
    & (NET_TS_CONCURRENCY_HINT_ID_MASK \
      | NET_TS_CONCURRENCY_HINT_LOCKING_ ## facility)) \
        ^ NET_TS_CONCURRENCY_HINT_ID) != 0)
...
#define NET_TS_CONCURRENCY_HINT_UNSAFE \
...
#if !defined(NET_TS_CONCURRENCY_HINT_DEFAULT)
# define NET_TS_CONCURRENCY_HINT_DEFAULT -1
#endif // !defined(NET_TS_CONCURRENCY_HINT_DEFAULT)

// This #define may be overridden at compile time to specify a program-wide
// concurrency hint, used by the one-argument io_context constructor when
// passed a value of 1.
#if !defined(NET_TS_CONCURRENCY_HINT_1)
# define NET_TS_CONCURRENCY_HINT_1 1
#endif // !defined(NET_TS_CONCURRENCY_HINT_DEFAULT)

#endif // NET_TS_DETAIL_CONCURRENCY_HINT_HPP
