...
#ifndef NET_TS_DETAIL_WINSOCK_INIT_HPP
#define NET_TS_DETAIL_WINSOCK_INIT_HPP
...
protected:
  ...
  NET_TS_DECL static void startup(data& d,
      unsigned char major, unsigned char minor);

  NET_TS_DECL static void manual_startup(data& d);

  NET_TS_DECL static void cleanup(data& d);

  NET_TS_DECL static void manual_cleanup(data& d);

  NET_TS_DECL static void throw_on_error(data& d);
};
...
#endif // NET_TS_DETAIL_WINSOCK_INIT_HPP
