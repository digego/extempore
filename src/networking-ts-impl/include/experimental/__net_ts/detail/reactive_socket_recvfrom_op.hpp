...
#ifndef NET_TS_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
#define NET_TS_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
...
public:
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    NET_TS_HANDLER_REACTOR_OPERATION((*o, "non_blocking_recvfrom",
...
{
public:
  NET_TS_DEFINE_HANDLER_PTR(reactive_socket_recvfrom_op);
...
#endif // NET_TS_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
