...
#ifndef NET_TS_DETAIL_IMPL_SOCKET_SELECT_INTERRUPTER_IPP
#define NET_TS_DETAIL_IMPL_SOCKET_SELECT_INTERRUPTER_IPP
...
void socket_select_interrupter::open_descriptors()
{
  ...
  if (acceptor.get() == invalid_socket)
    std::experimental::net::v1::detail::throw_error(ec, "socket_select_interrupter");
...
#endif // NET_TS_DETAIL_IMPL_SOCKET_SELECT_INTERRUPTER_IPP
