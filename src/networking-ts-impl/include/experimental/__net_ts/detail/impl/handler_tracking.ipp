...
#ifndef NET_TS_DETAIL_IMPL_HANDLER_TRACKING_IPP
#define NET_TS_DETAIL_IMPL_HANDLER_TRACKING_IPP
...
{
  static tracking_state state = { NET_TS_STATIC_MUTEX_INIT, 1, 0 };
  return &state;
}
...
#endif // NET_TS_DETAIL_IMPL_HANDLER_TRACKING_IPP
