...
#ifndef NET_TS_DETAIL_SOCKET_OPTION_HPP
#define NET_TS_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  {
    enabled(e);
    timeout NET_TS_PREVENT_MACRO_SUBSTITUTION(t);
  }
  ...
  void timeout NET_TS_PREVENT_MACRO_SUBSTITUTION(int value)
  {
#if defined(WIN32)
  ...
  int timeout NET_TS_PREVENT_MACRO_SUBSTITUTION() const
  {
...
#endif // NET_TS_DETAIL_SOCKET_OPTION_HPP
