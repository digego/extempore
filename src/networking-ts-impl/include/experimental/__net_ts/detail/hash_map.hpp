...
#ifndef NET_TS_DETAIL_HASH_MAP_HPP
#define NET_TS_DETAIL_HASH_MAP_HPP
...
public:
  ...
  {
    NET_TS_ASSERT(it != values_.end());
    NET_TS_ASSERT(num_buckets_ != 0);
...
private:
  ...
  static std::size_t hash_size(std::size_t num_elems)
  {
    ...
    {
#if defined(NET_TS_HASH_MAP_BUCKETS)
      NET_TS_HASH_MAP_BUCKETS
#else // NET_TS_HASH_MAP_BUCKETS
      3, 13, 23, 53, 97, 193, 389, 769, 1543, 3079, 6151, 12289, 24593,
      49157, 98317, 196613, 393241, 786433, 1572869, 3145739, 6291469,
      12582917, 25165843
#endif // NET_TS_HASH_MAP_BUCKETS
    };
...
#endif // NET_TS_DETAIL_HASH_MAP_HPP
