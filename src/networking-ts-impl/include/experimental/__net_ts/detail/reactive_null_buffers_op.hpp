...
#ifndef NET_TS_DETAIL_REACTIVE_NULL_BUFFERS_OP_HPP
#define NET_TS_DETAIL_REACTIVE_NULL_BUFFERS_OP_HPP
...
{
public:
  NET_TS_DEFINE_HANDLER_PTR(reactive_null_buffers_op);
...
#endif // NET_TS_DETAIL_REACTIVE_NULL_BUFFERS_OP_HPP
