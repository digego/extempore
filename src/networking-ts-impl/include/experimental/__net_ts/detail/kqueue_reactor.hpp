...
#ifndef NET_TS_DETAIL_KQUEUE_REACTOR_HPP
#define NET_TS_DETAIL_KQUEUE_REACTOR_HPP
...
public:
  ...
  // Constructor.
  NET_TS_DECL kqueue_reactor(std::experimental::net::v1::execution_context& ctx);

  // Destructor.
  NET_TS_DECL ~kqueue_reactor();
...
private:
  ...
  // cannot be created.
  NET_TS_DECL static int do_kqueue_create();
  ...
  NET_TS_DECL timespec* get_timeout(long usec, timespec& ts);
...
#endif // NET_TS_DETAIL_KQUEUE_REACTOR_HPP
