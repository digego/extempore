...
#ifndef NET_TS_IP_BASIC_RESOLVER_ITERATOR_HPP
#define NET_TS_IP_BASIC_RESOLVER_ITERATOR_HPP
...
public:
  ...
  basic_resolver_iterator(basic_resolver_iterator&& other)
    : values_(NET_TS_MOVE_CAST(values_ptr_type)(other.values_)),
      index_(other.index_)
  {
    other.index_ = 0;
  }
...
#endif // NET_TS_IP_BASIC_RESOLVER_ITERATOR_HPP
