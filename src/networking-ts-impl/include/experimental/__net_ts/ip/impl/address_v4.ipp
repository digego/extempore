...
address_v4::bytes_type address_v4::to_bytes() const NET_TS_NOEXCEPT
{
  using namespace std; // For memcpy.
  bytes_type bytes;
...
address_v4::uint_type address_v4::to_uint() const NET_TS_NOEXCEPT
{
...
bool address_v4::is_loopback() const NET_TS_NOEXCEPT
{
  return (to_uint() & 0xFF000000) == 0x7F000000;
}

bool address_v4::is_unspecified() const NET_TS_NOEXCEPT
{
  return to_uint() == 0;
}

bool address_v4::is_multicast() const NET_TS_NOEXCEPT
{
