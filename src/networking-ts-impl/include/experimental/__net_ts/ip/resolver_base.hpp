...
#ifndef NET_TS_IP_RESOLVER_BASE_HPP
#define NET_TS_IP_RESOLVER_BASE_HPP
...
public:
  ...
  enum flags
  {
    canonical_name = NET_TS_OS_DEF(AI_CANONNAME),
    passive = NET_TS_OS_DEF(AI_PASSIVE),
    numeric_host = NET_TS_OS_DEF(AI_NUMERICHOST),
    numeric_service = NET_TS_OS_DEF(AI_NUMERICSERV),
    v4_mapped = NET_TS_OS_DEF(AI_V4MAPPED),
    all_matching = NET_TS_OS_DEF(AI_ALL),
    address_configured = NET_TS_OS_DEF(AI_ADDRCONFIG)
  };
...
#endif // NET_TS_IP_RESOLVER_BASE_HPP
