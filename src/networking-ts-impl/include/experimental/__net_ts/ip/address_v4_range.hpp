...
#ifndef NET_TS_IP_ADDRESS_V4_RANGE_HPP
#define NET_TS_IP_ADDRESS_V4_RANGE_HPP
...
public:
  ...
  iterator find(const address_v4& addr) const NET_TS_NOEXCEPT
  {
...
#endif // NET_TS_IP_ADDRESS_V4_RANGE_HPP
