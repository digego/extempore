...
#ifndef NET_TS_IP_ADDRESS_V4_ITERATOR_HPP
#define NET_TS_IP_ADDRESS_V4_ITERATOR_HPP
...
public:
  ...
  basic_address_iterator(const address_v4& addr) NET_TS_NOEXCEPT
    : address_(addr)
  {
  }
  ...
  const address_v4& operator*() const NET_TS_NOEXCEPT
  {
    return address_;
  }
...
#endif // NET_TS_IP_ADDRESS_V4_ITERATOR_HPP
