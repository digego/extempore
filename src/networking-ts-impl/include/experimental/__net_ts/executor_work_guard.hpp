...
#ifndef NET_TS_EXECUTOR_WORK_GUARD_HPP
#define NET_TS_EXECUTOR_WORK_GUARD_HPP
...
public:
   ...
   */
  explicit executor_work_guard(const executor_type& e) NET_TS_NOEXCEPT
    : executor_(e),
      owns_(true)
  {
  ...
  /// Copy constructor.
  executor_work_guard(const executor_work_guard& other) NET_TS_NOEXCEPT
  ...
  bool owns_work() const NET_TS_NOEXCEPT
  {
    return owns_;
  }
...
#endif // NET_TS_EXECUTOR_WORK_GUARD_HPP
