...
#ifndef NET_TS_SOCKET_BASE_HPP
#define NET_TS_SOCKET_BASE_HPP
...
#else
    shutdown_receive = NET_TS_OS_DEF(SHUT_RD),
    shutdown_send = NET_TS_OS_DEF(SHUT_WR),
    shutdown_both = NET_TS_OS_DEF(SHUT_RDWR)
#endif
  };
...
#else
  NET_TS_STATIC_CONSTANT(int,
      message_peek = NET_TS_OS_DEF(MSG_PEEK));
  NET_TS_STATIC_CONSTANT(int,
      message_out_of_band = NET_TS_OS_DEF(MSG_OOB));
  NET_TS_STATIC_CONSTANT(int,
      message_do_not_route = NET_TS_OS_DEF(MSG_DONTROUTE));
  NET_TS_STATIC_CONSTANT(int,
      message_end_of_record = NET_TS_OS_DEF(MSG_EOR));
#endif
