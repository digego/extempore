...
_multiple_ Extempore processes (kindof like threads) as well as connecting to
...
![image](../../../assets/images/interacting-with-compiler/text-editor-start.png)
...
with <kbd>alt</kbd>+<kbd>O</kbd>. In ST2, use the menu item
`Tools > Extempore > Connect...`. The default host and port arguments will be
`localhost` and `7099` respectively. If the connection is made successfully,
then Extempore will echo back the string "Welcome to extempore!".
...
![image](../../../assets/images/interacting-with-compiler/scheme-eval.png)
...
![image](../../../assets/images/interacting-with-compiler/xtlang-eval-1.png)
...
Evaluating _xtlang_ code will always print a message to the log about the name
...
![image](../../../assets/images/interacting-with-compiler/xtlang-eval-2.png)
...
![image](../../../assets/images/interacting-with-compiler/xtlang-eval-3.png)
...
already exists. The compiler in this 'created default zone' message is just
telling us helpful things about the state of our Extempore world.

As another example of the difference between the _return value_ of an xtlang
expression and any _side effects_ it may introduce, have a think about how you
...
![image](../../../assets/images/interacting-with-compiler/xtlang-eval-4.png)
...
printing its arguments to the log or not. The actual _printing_ is a 'side
...
![image](../../../assets/images/interacting-with-compiler/doughnut-area.png)
...
![image](../../../assets/images/interacting-with-compiler/xtlang-eval-5.png)
...
![image](../../../assets/images/interacting-with-compiler/extempore-restart.png)
...
![image](../../../assets/images/interacting-with-compiler/xtlang-compile-error.png)
...
![image](../../../assets/images/interacting-with-compiler/xtlang-eval-6.png)

One other thing you can do is _redefine_ the behaviour of existing functions and
...
In the editor, _change the code_ for the `circle_area` closure and re-evaluate:

![image](../../../assets/images/interacting-with-compiler/xtlang-eval-7.png)

The result is (slightly) different, but not too far off---not bad for a 4000
year old formula. But the main thing is that the code to _call_ `circle_area`
...
behaves. In live programming, the programmer is constantly both building _new_
code and data structures, and also redefining and re-evaluating _old_ bits of
...
print all closures of a particular signature type, return the
[abstract syntax tree](http://en.wikipedia.org/wiki/Abstract_syntax_tree) of a
particular closure, etc… In fact the Extempore compiler itself is fully runtime
modifiable!
